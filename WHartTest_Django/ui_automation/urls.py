...
from .views import (
    ...
    ActuatorViewSet, UiBatchExecutionRecordViewSet, UiRecordingSessionViewSet, upload_screenshot, upload_trace,
...
router.register('recordings', UiRecordingSessionViewSet, basename='ui-recordings')
